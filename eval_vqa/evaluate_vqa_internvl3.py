...
ds_collections = {
    'vqav2_val': {
        ...
        'question': './data_annotation/vqav2/v2_OpenEnded_mscoco_val214_questions_subset.json',
...
class VQADataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # prefix_path = "./adv_output/87.5/val2014"
        # prefix_path = "./adv_output/CA/val2014"
        # 提取文件名
...
def evaluate_chat_model():
    base_prompt = 'You are doing the VQA Task, please answer me the following question in a word or short phrase.'
